...
class Eval_thread():
    ...
    def run(self):
        ...
        [mae, max_f, s] = map(lambda x: round(x, 3), [mae, max_f, s])

        self.LOG(
            '{} dataset with {} method get {:.3f} mae, {:.3f} S-measure, {:.3f} max-fmeasure.\n'.format(self.dataset,
                                                                                                        self.method,
                                                                                                        mae, s, max_f))
        return '{} dataset with {} method get {:.3f} mae, {:.3f} S-measure, {:.3f} max-fmeasure.'.format(self.dataset,
                                                                                                         self.method,
                                                                                                         mae, s, max_f)
